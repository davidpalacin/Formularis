...
// Funcion para saber el genero musical
...
echo <<< ENDHTML
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     <th style="width: 7em;"><a href='DavidPalacin1.php?id=$_GET[id]&orden=critica_fecha'>Fecha</a></th>
     <th style="width: 10em;"><a href='DavidPalacin1.php?id=$_GET[id]&orden=critica_nombre'>Nombre</th>
     <th><a href='DavidPalacin1.php?id=$_GET[id]&orden=critica_comentario'>Comentario</th>
     <th style="width: 5em;"><a href='DavidPalacin1.php?id=$_GET[id]&orden=critica_puntacion'>Valoracion</th>
    </tr>
ENDHTML;
...
echo <<<ENDHTML
  ...
  <form action="DavidPalacin2.php" method="post">
      <input name="id" type="hidden" value="$id">
      Cual es tu nombre: <input type="text" name="name"><br>
      Comenta la pelicula: <input type="text" name="coments"><br>
      Que valoracion le pondria a la pelicula</p>
      <select name="rating">
